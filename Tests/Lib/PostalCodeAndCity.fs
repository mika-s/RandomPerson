...
type ``stringToPostalCodeAndCity should`` () =
    ...
    [<TestMethod>]
    member this.``split a string of Norwegian data into a PostalCodeAndCity object`` () =
    ...
    [<TestMethod>]
    member this.``split a string of Swedish data into a PostalCodeAndCity object`` () =
