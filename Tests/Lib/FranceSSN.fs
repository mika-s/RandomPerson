...
[<TestClass>]
type ``generateIndividualNumber for French SSNs should`` () =
...
[<TestClass>]
type ``generateChecksum for French SSNs should`` () =
...
[<TestClass>]
type ``anonymizeSSN for French SSNs should`` () =
